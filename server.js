...
var mongoUser = process.env.LOGNAME || 'cs290_reidash';
var mongoPassword = process.env.MONGO_PASSWORD || 'cs290_reidash';
var mongoDBName = process.env.MONGO_DB_NAME || 'cs290_reidash';
